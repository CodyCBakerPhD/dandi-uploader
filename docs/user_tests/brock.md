...
- [x] A dataset flagged as containing human subjects data shows the warning banner and gates the dropzone/upload button until "I confirm" is clicked
...
Spatially group similar components; visibility such as the slider vs. the ignoring entry box with the selection buttons

Add 'back to HEARTH' button
